...
import { addCountryWithInfo } from '../../../api/graphql/countries';
...
const AddCountries = () => {
	...
	const handleAddCountry = async (e) => {
		...
		const newCountry = await addCountryWithInfo(currentValue);
	...
	return (
		<Box sx={style.containerStyle}>
			...
			>
				<form onSubmit={handleAddCountry} style={style.formStyle}>
